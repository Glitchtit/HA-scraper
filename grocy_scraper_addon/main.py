...
def _ai_sort_products(grocy: StorageClient, gemini_api_key: str, model: str = _GEMINI_DEFAULT_MODEL, *, product_ids: list[int] | None = None) -> int:
    ...
    for i in range(0, len(products), _GEMINI_BATCH_SIZE):
        ...
        prompt = (
            ...
            "ALL drinks of ANY kind (juices, sodas, energy drinks, sports drinks, water, beer, "
            "wine, cider, alcopops, coffee drinks, milk drinks — ALWAYS refrigerator, no exceptions); "
    ...
    if full_mode:
        ...
        for batch_idx, i in enumerate(range(0, len(products), _GEMINI_BATCH_SIZE)):
            ...
            prompt = (
                ...
                "Guidelines:\n"
                "- Location: dairy/meat/fresh -> refrigerator; "
                "ALL drinks of ANY kind (juice, soda, energy drink, sports drink, water, beer, wine, "
                "cider, alcopop, coffee drink, milk drink — ALWAYS refrigerator, no exceptions); "
